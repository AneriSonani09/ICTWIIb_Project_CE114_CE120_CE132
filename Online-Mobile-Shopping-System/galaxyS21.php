    ...
    <section class="section product-detail">
        <div class="details container-md">
            ...
            <div class="right">
                ...
                <h1>Galaxy S21</h1>
                <div class="price">₹75,999 <strike>₹1,04,999</strike></div>
                <form>
                    <div>
                        <select>
                ...
                <form class="form">
                    <a href="addtocart.php?id=<?php echo $id;?>&id1=5" class="addCart">Add To Cart</a>
                </form>
                ...
                <ul class="detail">
                    ...
                    <li>4800 mAh Lithium-ion Battery</li>
                    <li>Exynos 2100 Processor</li>
                </ul>
            </div>
        </div>
    </section>
