    ...
    <section class="section product-detail">
        <div class="details container-md">
            ...
            <div class="right">
                <span>Home/Mi</span>
                <h1>Redmi K20</h1>
                <div class="price">₹18,479 <strike>₹24,999</strike></div>
                <form>
                    <div>
                        <select>
                ...
                <form class="form">
                    <a href="addtocart.php?id=<?php echo $id;?>&id1=8" class="addCart">Add To Cart</a>
                </form>
                <h3>Product Details</h3>
                <ul class="detail">
                    <li>6 GB RAM | 128 GB ROM</li>
                    <li> 16.23 cm (6.39 inch) Full HD+ Display</li>
                    <li> 48MP + 13MP + 8MP | 20MP Front Camera</li>
                    <li> 4000 mAh Li-polymer Battery</li>
                    <li> Qualcomm Snapdragon 730 Processor</li>
            ...
            <div class="product">
              ...
              <div class="product">
                ...
                <div class="product-footer">
                  ...
                  <h4 class="price">₹51,999 <strike>₹54,999</strike></h4>
                </div>
              </div>
              <div class="product">
                <div class="product-header">
