    ...
    <section class="section product-detail">
        <div class="details container-md">
            ...
            <div class="right">
                ...
                <form class="form">
                    <a href="addtocart.php?id=<?php echo $id;?>&id1=4" class="addCart">Add To Cart</a>
                </form>
                <h3>Product Details</h3>
                <ul class="detail">
                    <li>8GB/12GB</li>
                    <li>Qualcomm™ Snapdragon® 870 and 5G</li>
                    <li>4×4 MIMO, Supports up to DL Cat 18/UL Cat 18 (1.2Gbps /200Mbps), depending on carrier support</li>
                    <li>120 Hz Fluid AMOLED Display</li>
                    <li>Dual Stereo Speakers; Noise cancellation support; Dolby Atmos®</li>
                </ul>
            </div>
        </div>
    </section>
