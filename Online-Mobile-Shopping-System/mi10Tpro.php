    ...
    <section class="section product-detail">
        <div class="details container-md">
            ...
            <div class="right">
                <span>Home/Mi</span>
                <h1>Mi 10i</h1>
                <div class="price">₹36,999 <strike>₹47,999</strike></div>
                <form>
                    <div>
                        <select>
                ...
                <form class="form">
                    <a href="addtocart.php?id=<?php echo $id;?>&id1=7" class="addCart">Add To Cart</a>
                </form>
                ...
                <ul class="detail">
                    ...
                    <li>144Hz Intelligent AdaptiveSync Display</li>
                    <li>33W Dual Split Flash Charge</li>
    ...
    <section class="section featured">
        ...
        <div class="product-center container">
            ...
            <div class="product">
                ...
                <div class="product-footer">
                    <a href="galaxyA72.php?id=<?php echo $id;?>">
